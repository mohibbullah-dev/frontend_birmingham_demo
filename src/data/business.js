export const business = {
  ...
  highlights: [
    { title: "Fast response", desc: "Emergency call-outs and same-day slots." },
    { title: "Clear pricing", desc: "Quote confirmed before work starts." },
    {
      title: "Local & insured",
      desc: "Local Birmingham plumbers (demo copy).",
    },
  ],
